#python script using nornir_scrapli plugin "send_commands_from_file"
#script will send configuration commands listed in "random_commands.txt"
#file to all the hosts in the nornir host file
